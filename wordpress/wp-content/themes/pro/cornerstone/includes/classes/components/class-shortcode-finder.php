...
/* Integration functions */
  ...
  public function the_grid( $enable ) {
      ...
      if ( !is_admin() ) {
        ...
        if ( $this->has( $shortcode) ) return true;
  ...
  public function revslider ($options) {
    ...
    if( !is_admin() ) {
      ...
      $above = get_post_meta( $post->ID, '_x_slider_above', true );
      $below = get_post_meta( $post->ID, '_x_slider_below', true );
      ...
      if ( $this->has( $shortcode) || $above || $below ) $options['allinclude'] = "true";
