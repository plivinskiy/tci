...
return array(
  ...
  'design-cloud.validate' => __( 'Your license must be validated before you can install templates from Design Cloud.', '__x__' ),
  'design-cloud.notify.validate' => __( 'Please validate to install Design Cloud Templates.', '__x__' ),

  'design-cloud.submit.name-required'      => __( 'Your submission must have a name.', '__x__' ),
  'design-cloud.submit.thumbnail-required' => __( 'Your submission must have a thumbnail.', '__x__' ),
  'design-cloud.submit.selection-required' => __( 'Make a template selection.', '__x__' ),
  'design-cloud.submit.submitting'         => __( 'Submitting...', '__x__' ),
  'design-cloud.submit.uploaded'           => __( 'Submission uploaded.', '__x__' ),
  'design-cloud.submit.failed-to-upload'   => __( 'Failed to upload submission.', '__x__' ),
