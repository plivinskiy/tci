...
function x_control_partial_off_canvas( $settings ) {
  ...
  $control_off_canvas_content_dynamic_rendering = cs_partial_controls('rvt:dynamic-rendering', [
    'key' => 'off_canvas_content_dynamic_rendering',
  ]);
  ...
  if ( $is_layout_element === false ) {
    $control_list_setup = [
      ...
      $control_off_canvas_content_dynamic_rendering,
    ];
  }
