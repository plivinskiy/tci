...
if (!class_exists('Radium_Theme_Importer')) {
  ...
  class Radium_Theme_Importer
  {
    ...
    public $end;
    public $content_end;
    public $exclude_importer;
    public $rev_slider_files;
    public $content_part;
    ...
    public function __construct()
    {
      ...
      $this->exclude_importer   = $this->exclude_importer;
    ...
    public function after_wp_importer( $atts = false )
    {
      ...
      if(isset($this->active_import[$this->active_import_id]['active_set_homepage'])){
        do_action('wgl_importer_skin_content_import', $this->active_import, $this->demo_files_path);
        echo '<p>', esc_html('All done.'), ' <a href="', admin_url(), '">', esc_html('Have fun!'), '</a>' . '</p>';
      }

      if(isset($this->active_import[$this->active_import_id]['active_skin_importer']) && isset($this->active_import[$this->active_import_id]['wgl_custom_exclude_import'])){
        echo '<p>', esc_html('All done.'), ' <a href="', admin_url(), '">', esc_html('Have fun!'), '</a>' . '</p>';
      }

      if ($this->part == '10') {
        if(!isset($this->active_import[$this->active_import_id]['active_skin_importer'])){
    ...
    public function process_imports()
    {
      ...
      if(!empty($this->exclude_importer)){
        echo '<p>', esc_html('All done.'), ' <a href="', admin_url(), '">', esc_html('Have fun!'), '</a>' . '</p>';
      }
