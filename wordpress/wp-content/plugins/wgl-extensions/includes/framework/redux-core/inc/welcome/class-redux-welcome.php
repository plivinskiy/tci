...
if ( ! class_exists( 'Redux_Welcome', false ) ) {
	...
	class Redux_Welcome {
		...
		public function do_redirect() {
			if ( ! defined( 'WP_CLI' ) ) {
				wp_safe_redirect( esc_url( admin_url( add_query_arg( array( 'page' => 'wgl-extensions' ), 'options-general.php' ) ) ) );
				exit();
			}
		}
		...
		public function admin_menus() {
			...
			// About Page.
			$page( esc_html__( 'What is Redux Framework?', 'wgl-extensions' ), esc_html__( 'Redux', 'wgl-extensions' ), $this->minimum_capability, 'redux-framework', array( $this, 'about_screen' ) );
		}
		...
		public function tabs() {
			...
			<h2 class="nav-tab-wrapper">
				<a
					...
					href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'wgl-extensions' ), 'options-general.php' ) ) ); ?>">
