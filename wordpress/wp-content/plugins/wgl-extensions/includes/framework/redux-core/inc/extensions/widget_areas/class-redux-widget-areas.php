				...
				<div id="redux-add-widget" class="widgets-holder-wrap">
					<div class="">
						...
						<div class="sidebar-name">
							<h3><?php echo esc_html__( 'Create Widget Area', 'wgl-extensions' ); ?> <span class="spinner"></span></h3>
						</div>
							...
							<form id="addWidgetAreaForm" action="" method="post">
								...
								<div class="widget-content">
									<input
											...
											class="regular-text"
											title="<?php echo esc_attr__( 'Name', 'wgl-extensions' ); ?>"
											placeholder="<?php echo esc_attr__( 'Name', 'wgl-extensions' ); ?>"/>
								</div>
								<div class="widget-control-actions">
									<div class="aligncenter">
										<input
												...
												type="submit"
												value="<?php echo esc_attr__( 'Create Widget Area', 'wgl-extensions' ); ?>"/>
									</div>
									<br class="clear">
								</div>
							</form>
		...
		public function enqueue() {
			...
			wp_localize_script(
				...
				array(
					...
					'delete'  => esc_html__( 'Delete', 'wgl-extensions' ),
					'confirm' => esc_html__( 'Confirm', 'wgl-extensions' ),
					'cancel'  => esc_html__( 'Cancel', 'wgl-extensions' ),
				)
			);
		}
	}
