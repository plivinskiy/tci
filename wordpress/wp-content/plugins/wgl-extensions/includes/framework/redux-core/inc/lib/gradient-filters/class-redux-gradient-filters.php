	...
	class Redux_Gradient_Filters {
		...
		public static function render_sliders( array $data ): string {
			...
			if ( $field['gradient-reach'] ) {
				...
				$output .= '<div class="label">' . esc_html__( 'From Reach ', 'wgl-extensions' ) . ':  <strong>' . esc_html( $value['gradient-reach']['from'] ) . '%</strong></div>';
				$output .= '<div ';
				...
				$output .= '<div class="label">' . esc_html__( 'To Reach', 'wgl-extensions' ) . ':  <strong>' . esc_html( $value['gradient-reach']['to'] ) . '%</strong></div>';
				$output .= '<div ';
			...
			if ( $field['gradient-angle'] ) {
				...
				$output .= '<div class="label">' . esc_html__( 'Gradient Angle', 'wgl-extensions' ) . ':  <strong>' . $value['gradient-angle'] . '&deg;</strong></div>';
				$output .= '<div ';
