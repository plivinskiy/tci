		...
		public function render() {
			...
			foreach ( $shadow_arr as $shadow_type ) {
				if ( $this->field[ $shadow_type . '-shadow' ] ) {
					...
					echo esc_html__( 'Horizontal Length ', 'wgl-extensions' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['horizontal'] ) . 'px</strong>';
					echo '<div
					...
					echo esc_html__( 'Vertical Length ', 'wgl-extensions' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['vertical'] ) . 'px</strong>';
					echo '<div
					...
					echo esc_html__( 'Blur Radius ', 'wgl-extensions' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['blur'] ) . 'px</strong>';
					echo '<div
					...
					echo esc_html__( 'Spread ', 'wgl-extensions' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['spread'] ) . 'px</strong>';
					echo '<div
