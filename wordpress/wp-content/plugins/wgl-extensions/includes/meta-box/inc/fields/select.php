...
class RWMB_Select_Field extends RWMB_Choice_Field {
	...
	public static function get_select_all_html( $field ) {
		if ( $field['multiple'] && $field['select_all_none'] ) {
			return '<div class="rwmb-select-all-none">' . __( 'Select', 'wgl-extensions' ) . ': <a data-type="all" href="#">' . __( 'All', 'wgl-extensions' ) . '</a> | <a data-type="none" href="#">' . __( 'None', 'wgl-extensions' ) . '</a></div>';
		}
		return '';
	}
}
