...
class RWMB_Background_Field extends RWMB_Field {
	...
	public static function html( $meta, $field ) {
		...
		$image   = RWMB_File_Input_Field::normalize( [
			...
			'placeholder' => __( 'Background Image', 'wgl-extensions' ),
		] );
		...
		$repeat  = RWMB_Select_Field::normalize( [
			...
			'placeholder' => esc_html__( '-- Repeat --', 'wgl-extensions' ),
			'options'     => [
		...
		$position = RWMB_Select_Field::normalize( [
			...
			'placeholder' => esc_html__( '-- Position --', 'wgl-extensions' ),
			'options'     => [
		...
		$attachment = RWMB_Select_Field::normalize( [
			...
			'placeholder' => esc_html__( '-- Attachment --', 'wgl-extensions' ),
			'options'     => [
