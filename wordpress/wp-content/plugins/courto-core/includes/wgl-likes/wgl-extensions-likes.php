...
class WGL_Post_Likes
{
    ...
    public function get_likes_button($post_id = 0, $is_comment = false)
    {
        ...
        $title_like = esc_html_x('Like', 'likes button', 'courto-core');
        $title_unlike = esc_html_x('Unlike', 'likes button', 'courto-core');
    ...
    public function get_liked_icon()
    {
        ...
        return '<span class="sl-icon liked">'. wgl_dynamic_styles()->wgl_theme_svg()['liked'] .'</span>';
    }

    public function get_unliked_icon()
    {
        // If Font Awesome is needed, replace with: <i class="sl-icon fa fa-heart-o"></i>
        return '<span class="sl-icon unliked">'. wgl_dynamic_styles()->wgl_theme_svg()['like'] .'</span>';
    }
    ...
    public function get_like_count($like_count)
    {
        ...
        $out .= '<span class="sl-count-text"> ' . esc_html( _n('Like', 'Likes', $like_count, 'courto-core') ) . '</span>';
    ...
    public function init()
    {
        ...
        if ( !wp_verify_nonce( $nonce, 'simple-likes-nonce' ) ) {
            exit( esc_html__('Not permitted', 'courto-core') );
        }
