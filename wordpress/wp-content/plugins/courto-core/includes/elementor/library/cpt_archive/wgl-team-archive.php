 ...
 * @version 1.0.0
 */
class WGL_Team_Archive extends Library_Document
{
	/**
	...
	*/
	...
	public static function get_type() {
		return 'wgl_team_archive';
	}

	/**
	* WGL Library name.
	*/
	public static $name = 'wgl-team-archive';
	...
	public static function get_properties(){
		...
		$properties['location'] = 'wgl_team_archive';
		$properties['condition_type'] = 'wgl_team_archive';
	...
	public static function get_title() {
		return esc_html__( 'WGL Team Archive', 'courto-core' );
	}
	...
	public static function get_single_template($single_template){
		...
		if(self::CPT === $post->post_type && self::$name === $template_type) {
			$single_template = plugin_dir_path(  __FILE__  ) . 'templates/single-team-archive.php';
		}
