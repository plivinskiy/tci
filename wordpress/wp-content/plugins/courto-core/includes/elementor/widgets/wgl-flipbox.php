...
class WGL_Flipbox extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Flipbox', 'courto-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'dev_view',
            [
                'label' => esc_html__('Show Back Side', 'courto-core'),
                'description' => esc_html__('This option does not affect the result in any way', 'courto-core'),
        ...
        $this->add_control(
            'flip_direction',
            [
                'label' => esc_html__('Flip Direction', 'courto-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'flip_right' => esc_html__('Right', 'courto-core'),
                    'flip_left' => esc_html__('Left', 'courto-core'),
                    'flip_top' => esc_html__('Top', 'courto-core'),
                    'flip_bottom' => esc_html__('Bottom', 'courto-core'),
                ],
                'default' => 'flip_right',
            ]
        );
        ...
        $this->add_responsive_control(
            'flipbox_height',
            [
                'label' => esc_html__('Module Height', 'courto-core'),
        ...
        $this->start_controls_tab(
            'tab_item_front',
            ['label' => esc_html__('Front', 'courto-core')]
        );
        ...
        $this->start_controls_tab(
            'tab_item_back',
            ['label' => esc_html__('Back', 'courto-core')]
        );
        ...
        WGL_Icons::init(
            $this,
            [
                'label' => esc_html__('Flipbox ', 'courto-core'),
                'output' => '',
                'section' => false,
	            'default' => [
		            'media_type' => '',
        ...
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'label_block' => true,
                'placeholder' => esc_attr__('Play to Earn', 'courto-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'label_block' => true,
                'placeholder' => esc_attr__('Flipbox Title', 'courto-core'),
                'default' => esc_html__('Flipbox Title', 'courto-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'before',
                'label_block' => true,
                'placeholder' => esc_attr__('Front Content', 'courto-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'label_block' => true,
                'placeholder' => esc_attr__('Back Content', 'courto-core'),
                'default' => esc_attr__('Quiet propulsion and less time lost at the fueling dock make the best way to spend time on the water', 'courto-core'),
            ]
        );
        ...
        $this->add_control(
            'back_content_trail',
            [
                'label' => esc_html__('Add Content Trailing Line', 'courto-core'),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Front Background', 'courto-core'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Back Background', 'courto-core'),
                'types' => ['classic', 'gradient'],
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    ...
                    'button_custom_fonts_text_decoration' => ['line-through', 'overline', 'underline'] ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button .button__text' => 'text-decoration-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button' => 'border-color: {{VALUE}}'
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    ...
                    'button_custom_fonts_text_decoration' => ['line-through', 'overline', 'underline'] ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover span' => 'text-decoration-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    ...
                    'button_custom_fonts_text_decoration' => ['line-through', 'overline', 'underline'] ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active span' => 'text-decoration-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button .wgl-icon' => 'color: {{VALUE}}; fill: {{VALUE}};',
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button' => '--read-more-icon-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button .wgl-icon,
				     {{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button .wgl-icon::before' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button .wgl-icon,
				     {{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button .wgl-icon::before' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button' => '--wgl-icon-gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'mobile_default' => ['unit' => 'deg'],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button .wgl-icon' => '--icon-rotate: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover .wgl-icon' => 'color: {{VALUE}}; fill: {{VALUE}};',
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover' => '--read-more-icon-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover .wgl-icon,
				     {{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover .wgl-icon::before' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover .wgl-icon,
				     {{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover .wgl-icon::before' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover' => '--wgl-icon-gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'mobile_default' => ['unit' => 'deg'],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:hover .wgl-icon' => '--icon-rotate: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active .wgl-icon' => 'color: {{VALUE}}; fill: {{VALUE}};',
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active' => '--read-more-icon-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active .wgl-icon,
				     {{WRAPPER}} .wgl-flipbox .wgl-widget__button:active .wgl-icon::before' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active .wgl-icon,
				     {{WRAPPER}} .wgl-flipbox .wgl-widget__button:active .wgl-icon::before' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active' => '--wgl-icon-gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'mobile_default' => ['unit' => 'deg'],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active .wgl-icon' => '--icon-rotate: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button' => '--wgl-bg-gradient-primary: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button' => '--wgl-bg-gradient-secondary: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#A96FF3',
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus)' => '--wgl-bg-gradient-primary: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#5A76F7',
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus)' => '--wgl-bg-gradient-secondary: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active' => '--wgl-bg-gradient-primary: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active' => '--wgl-bg-gradient-secondary: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button::after' => '--wgl-border-gradient-primary: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button::after' => '--wgl-border-gradient-secondary: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus, :active)::after' => '--wgl-border-gradient-primary: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus, :active)::after' => '--wgl-border-gradient-secondary: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button::after' => '--pos-x: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button::after' => '--pos-y:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button::after' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button::after' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button::after' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button::after' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus)::after' => '--pos-x: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus)::after' => '--pos-y:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus)::after' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus)::after' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus)::after' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus)::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus)::after' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active::after' => '--pos-x: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active::after' => '--pos-y:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active::after' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active::after' => 'height: {{SIZE}}{{UNIT}};',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active::after' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active::after' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [ 'button_animation_style' => 'border_animation' ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button' => '--ab-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => ['size' => 6],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button' => '--ab-offset: {{SIZE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => ['size' => 1],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button' => '--ab-width: {{SIZE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => ['size' => 4],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button' => '--ab-extend: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'range' => [ 'px' => [ 'min' => 0, 'max' => 5, 'step' => 0.01 ] ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button .wgl-icon' => '--icon-scale: {{SIZE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'range' => [ 'px' => [ 'min' => 0, 'max' => 5, 'step' => 0.01 ] ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox:hover .wgl-widget__button .wgl-icon' => '--icon-bg-scale: {{SIZE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'range' => [ 'px' => [ 'min' => 0, 'max' => 5, 'step' => 0.01 ] ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus) .wgl-icon' => '--icon-scale: {{SIZE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'range' => [ 'px' => [ 'min' => 0, 'max' => 5, 'step' => 0.01 ] ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:is(:hover, :focus) .wgl-icon' => '--icon-bg-scale: {{SIZE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'range' => [ 'px' => [ 'min' => 0, 'max' => 5, 'step' => 0.01 ] ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active .wgl-icon' => '--icon-scale: {{SIZE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'range' => [ 'px' => [ 'min' => 0, 'max' => 5, 'step' => 0.01 ] ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-flipbox .wgl-widget__button:active .wgl-icon' => '--icon-bg-scale: {{SIZE}};',
                ],
            ]
        );
        $this->end_controls_tab();
    ...
    public function render()
    {
        ...
        if ($_s['add_read_more']) {
            ...
            $fb_button = '<div class="wgl-button-wrapper'.('button-read-more' === $_s['button_type'] ? ' rm_btn' : '' ).'">';
                $fb_button .= 'button-read-more' === $_s['button_type'] ? '<div class="read-more-wrap">' : '';
                    $fb_button .= sprintf(
                        '<%s %s %s>',
                        ...
                        $fb_button .= 'wgl-button' === $_s['button_type'] ? '<div class="button__content">' : '';
                            $fb_button .= $btn_icon ?: '';
                            $fb_button .= $_s['read_more_text'] ? '<span class="button__text">' . $_s['read_more_text'] . '</span>' : '';
                        $fb_button .= 'wgl-button' === $_s['button_type'] ? '</div>' : '';
                    $fb_button .= $_s['module_link'] ? '</div>' : '</a>';
                $fb_button .= 'button-read-more' === $_s['button_type'] ? '</div>' : '';
            $fb_button .= '</div>';
        }
        ...
        echo '<div ', $this->get_render_attribute_string('flipbox'), '>';
            echo '<div class="wgl-flipbox_wrap">';
                ...
                echo '</div>'; // wgl-flipbox_back

            echo '</div>';

            if ($_s['module_link']) {
                echo '<a class="wgl-flipbox_item-link" ', $this->get_render_attribute_string('flipbox_link'), '></a>';
            }
