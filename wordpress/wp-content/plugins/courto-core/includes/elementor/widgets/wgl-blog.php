...
class WGL_Blog extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Blog', 'courto-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    '740x560' => esc_html__('740x560 - 3 Columns', 'courto-core'),
                    '830x560' => esc_html__('830x560 - 2 Columns', 'courto-core'),
                    '1170x720' => esc_html__('1170x720 - 1 Column', 'courto-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    '10:7,1:1' => esc_html__('Chess Type ( 10:7 / 1:1 )', 'courto-core'),
                    '1:1,10:7' => esc_html__('Chess Type ( 1:1 / 10:7 )', 'courto-core'),
                ],
                'default' => '',
            ]
        );
        ...
        $this->add_control(
            'media_link',
            [
                'label' => esc_html__('Clickable Image?', 'courto-core'),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'item_bg',
            [
                'label' => esc_html__('Add Item Background', 'courto-core'),
                'type' => Controls_Manager::SWITCHER,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'media_overlay_idle',
            [
                'label' => esc_html__('Image Overlay Idle', 'courto-core'),
                'type' => Controls_Manager::SWITCHER,
                'separator' => 'before',
                'selectors' => [
        ...
        $this->add_control(
            'media_overlay_hover',
            [
                'label' => esc_html__('Image Hover Overlay', 'courto-core'),
                'type' => Controls_Manager::SWITCHER,
                'separator' => 'before',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .button-read-more' => '--read-more-icon-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .button-read-more:hover' => '--read-more-icon-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
