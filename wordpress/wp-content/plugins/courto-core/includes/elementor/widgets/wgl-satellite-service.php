<?php
/**
 * This template can be overridden by copying it to `yourtheme[-child]/wgl-extensions/elementor/widgets/wgl-satellite-service.php`.
 */
...
class WGL_Satellite_Service extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Satellite Service', 'courto-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $output[ 'media_width' ] = [
            'label' => esc_html__('Media Width (Height)', 'courto-core'),
        ...
        $this->start_controls_section(
            'wgl_ib_content',
            [
                'label' => esc_html__('Service Content', 'courto-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'courto-core'),
            ]
        );
        ...
        $this->start_controls_section(
            'section_style_link',
            [ 'label' => esc_html__('Service Link', 'courto-core') ]
        );

        $this->add_control(
            'add_item_link',
            [
                'label' => esc_html__('Add Link To Whole Item', 'courto-core'),
        ...
        $this->add_control(
            'add_read_more',
            [
                'label' => esc_html__('Add \'Read More\' Button', 'courto-core'),
                'type' => Controls_Manager::SWITCHER,
                'condition' => [ 'add_item_link!' => 'yes' ],
                'label_on' => esc_html__('On', 'courto-core'),
                'label_off' => esc_html__('Off', 'courto-core'),
        ...
        $this->add_control(
            'link',
            [
                'label' => esc_html__('Button Link', 'courto-core'),
                'type' => Controls_Manager::URL,
			    'dynamic' => ['active' => true],
                'condition' => [ 'add_read_more' => 'yes' ],
                'label_block' => true,
        ...
        $this->add_control(
            'primary_color',
            [
                'label' => esc_html__('Primary Color', 'courto-core'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'mobile_default' => [ 'unit' => '%' ],
                'selectors' => [
                    '{{WRAPPER}} .wgl-image-box_img' => 'width: {{SIZE}}{{UNIT}}; display: inline-block;',
                ],
            ]
        );
        ...
        $this->add_control(
            'border_type',
            [
                'label' => esc_html__('Border Type', 'Border Control', 'courto-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'solid' => esc_html__('Solid', 'Border Control', 'courto-core'),
                    'double' => esc_html__('Double', 'Border Control', 'courto-core'),
                    'dotted' => esc_html__('Dotted', 'Border Control', 'courto-core'),
                    'dashed' => esc_html__('Dashed', 'Border Control', 'courto-core'),
                    'groove' => esc_html__('Groove', 'Border Control', 'courto-core'),
                ],
                'default' => 'dashed',
                'selectors' => [
        ...
        $this->add_control(
            'circle_width',
            [
                'label' => esc_html__('Circles Width(Height)', 'courto-core'),
                'type' => Controls_Manager::NUMBER,
			    'dynamic' => ['active' => true],
                'min' => 2,
                'step' => 1,
        ...
        $this->add_control(
            'circle_color_1',
            [
                'label' => esc_html__('First Circle Color', 'courto-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
        ...
        $this->add_control(
            'circle_color_2',
            [
                'label' => esc_html__('Second Circle Color', 'courto-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
