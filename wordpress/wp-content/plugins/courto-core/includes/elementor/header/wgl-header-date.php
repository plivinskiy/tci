...
class WGL_Header_Date extends Widget_Base
{
    ...
    public function get_title() {
        return esc_html__('WGL Current Date', 'courto-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Date Settings', 'courto-core'),
            ]
        );
        ...
        $this->add_control(
            'date_format_select',
            [
                'label' => esc_html__('Date Format', 'courto-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'default' => esc_html__('Default', 'courto-core'),
                    'wordpress_format' => esc_html__('Wordpress Format', 'courto-core'),
        ...
        $this->add_control(
            'date_format_custom',
            [
                'label' => esc_html__('Custom Date Format', 'courto-core'),
                ...
                'description' => __( 'Set your date format, about this, please refer to the ', 'courto-core') . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'https://wordpress.org/support/article/formatting-date-and-time/', __( 'Wordpress.org', 'courto-core') ),
            ]
        );
        ...
        $this->add_control(
            'time_zone',
            [
                'label' => esc_html__('Time Zone', 'courto-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'UTC' => esc_html__('Default', 'courto-core'),
	    ...
	    $this->start_controls_section(
		    'section_date_style',
		    [
			    'label' => esc_html__('Date Style', 'courto-core'),
		    ]
	    );
        ...
        $this->add_control(
            'month_year_color',
            [
                'label' => esc_html__('Month and Year Colors', 'courto-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
