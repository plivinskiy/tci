...
class WGL_Header_List_Info extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Icon + Text', 'courto-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'label_block' => true,
                'placeholder' => esc_attr__('List Item', 'courto-core'),
                'default' => esc_html__('List Item', 'courto-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    ['text' => esc_html__('List Item #1', 'courto-core')],
                    ['text' => esc_html__('List Item #2', 'courto-core')],
                    ['text' => esc_html__('List Item #3', 'courto-core')],
                ],
                'title_field' => '{{{ text }}}',
            ]
        );
        ...
        $this->start_controls_section(
            'section_style_list',
            [
                'label' => esc_html__('List', 'courto-core'),
        ...
        $this->add_responsive_control(
            'space_between',
            [
                'label' => esc_html__('Gap Items', 'courto-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'solid' => esc_html__('Solid', 'courto-core'),
                    'double' => esc_html__('Double', 'courto-core'),
                    'dotted' => esc_html__('Dotted', 'courto-core'),
                    'dashed' => esc_html__('Dashed', 'courto-core'),
                ],
                'default' => 'solid',
                'selectors' => [
        ...
        $this->add_control(
            'divider_weight',
            [
                'label' => esc_html__('Weight', 'courto-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'condition' => ['divider' => 'yes'],
                'range' => [
        ...
        $this->add_responsive_control(
            'icon_spacing',
            [
                'label' => esc_html__('Gap Icons', 'courto-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => ['min' => 0, 'max' => 100],
        ...
        $this->add_control(
            'text_indent',
            [
                'label' => esc_html__('Text Indent', 'courto-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'separator' => 'before',
                'range' => [
