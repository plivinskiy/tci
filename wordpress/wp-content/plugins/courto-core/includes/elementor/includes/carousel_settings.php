    ...
    class WGL_Carousel_Settings
    {
        ...
        public static function add_controls($self, $extra_fields = [])
        {
            ...
            $self->add_control(
                'use_carousel',
                [
                    'label' => esc_html__('Use Carousel', 'courto-core'),
            ...
            self::add_general_controls($self, [
                ...
                'variable_width_height' => [
                    'condition' => [ 'use_carousel' => 'yes' ] + ($extra_fields['variable_width_height']['condition'] ?? []),
                    'default' => ($extra_fields['variable_width_height']['default'] ?? null),
                    'wrapper' => ($extra_fields['variable_width_height']['wrapper'] ?? null),
                ],
                ...
                'opacity_slides' => [
                    'condition' => [ 'use_carousel' => 'yes' ],
                    'default' => ($extra_fields['opacity_slides']['default'] ?? null),
                ],
                ...
                'linear_animation' => [
                    'condition' => [ 'use_carousel' => 'yes' ],
                    'default' => ($extra_fields['linear_animation']['default'] ?? ''),
                ],
                'slider_infinite' => [
                    'condition' => [ 'use_carousel' => 'yes' ],
                ...
                'adaptive_height' => [
                    'condition' => [ 'use_carousel' => 'yes' ],
                    'default' => ($extra_fields['adaptive_height']['default'] ?? ''),
                ],
                'fade_animation' => [
                    'condition' => [ 'use_carousel' => 'yes' ],
                ],
                'center_mode' => [
                    'condition' => [ 'use_carousel' => 'yes' ],
                    'default' => ($extra_fields['center_mode']['default'] ?? ''),
                ],
            ]);
            ...
            self::add_navigation_controls($self, [
                ...
                'navigation_distance' => [
                    'condition' => ($extra_fields['navigation_distance']['condition'] ?? null),
                    'default' => ($extra_fields['navigation_distance']['default'] ?? null),
                    'tablet_default' => ($extra_fields['navigation_distance']['tablet_default'] ?? null),
                    'mobile_default' => ($extra_fields['navigation_distance']['mobile_default'] ?? null),
                ],
                'navigation_position' => [
        ...
        public static function add_general_controls($self, $extra_fields = [])
        {
            $self->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        ...
                        '{{WRAPPER}} .wgl-carousel_wrapper' => 'padding: 0 {{RIGHT}}{{UNIT}} 0 {{LEFT}}{{UNIT}};',
                        '{{WRAPPER}} .wgl-carousel.swiper' => 'padding: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
                    ],
                ]
            );
            ...
            $self->add_control(
                'slides_transition',
                [
                    'label' => esc_html__( 'Animation Duration (ms)', 'courto-core' ),
            ...
            $self->add_control(
                'disable_overflow',
                [
                    'label' => esc_html__('Disable Overflow', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
            ...
            $self->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::SWITCHER,
                    'default' => ($extra_fields['carousel_appear_animation']['default'] ?? ''),
                    'condition' => [
                        'animation_style' => ['default'],
            ...
            $self->add_control(
                'variable_width',
                [
                    'label' => esc_html__('Variable Width', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'render_type' => 'template',
                    'condition' => [
                            'animation_style' => ['default', 'default_vertical'],
                        ] + ($extra_fields['variable_width']['condition'] ?? []),
                    'default' => ($extra_fields['variable_width']['default'] ?? ''),
                ]
            );
            ...
            $self->add_responsive_control(
                'variable_width_height',
                [
                    'label' => esc_html__('Set Height', 'courto-core'),
                    'type' => Controls_Manager::NUMBER,
                    'dynamic' => ['active' => true],
                    'condition' => [
                            'animation_style' => ['default', 'default_vertical'],
                            'variable_width!' => '',
                        ] + ($extra_fields['variable_width_height']['condition'] ?? []),
                    'selectors' => [
                        '{{WRAPPER}} '.($extra_fields['variable_width_height']['wrapper'] ?? '.swiper-slide') => 'height: {{VALUE}}px;',
                    ],
                ]
            );
            ...
            $self->add_control(
                ...
                [
                    ...
                    'options' => [
                        'default' => esc_html__('Horizontal Default', 'courto-core'),
                        'default_vertical' => esc_html__('Vertical Default', 'courto-core'),
                    ] + ( !empty($extra_fields['3d_animation_options']) ? [
                        'horizontal' => esc_html__('Horizontal 3D', 'courto-core'),
                        'vertical' => esc_html__('Vertical 3D', 'courto-core'),
                    ] : [] ),
            ...
            $self->add_control(
                ...
                [
                    'raw' => esc_html__( 'There will be 1 Slides per Viewing.', 'courto-core' ),
                    'type' => Controls_Manager::RAW_HTML,
            ...
            $self->add_responsive_control(
                'animation_vertical_padding',
                [
                    'label' => esc_html__('Visibility for Next/Prev Slides', 'courto-core'),
                    'description' => esc_html__('Use this options to show part of Next/Prev Slides', 'courto-core'),
                    'type' => Controls_Manager::DIMENSIONS,
            ...
            $self->add_control(
                'animation_triggered_by_mouse',
                [
                    'label' => esc_html__('Triggered by Mouse Wheel', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'render_type' => 'template',
                    'condition' => [
                            'linear_animation!' => 'yes'
                        ] + ($extra_fields['animation_triggered_by_mouse']['condition'] ?? []),
                    'selectors' => [
            ...
            $self->add_responsive_control(
                'opacity_slides',
                [
                    'label' => esc_html__('Transparency for Slides (Exc: First)', 'courto-core'),
                    'type' => Controls_Manager::SLIDER,
                    'dynamic' => ['active' => true],
                    'separator' => 'before',
                    ...
                    'default' => $extra_fields['opacity_slides']['default'] ?? [],
                    'selectors' => [
            ...
            $self->add_responsive_control(
                'opacity_slides_additional',
                [
                    'label' => esc_html__('Transparency for Slides (Exc: First, Next, Prev)', 'courto-core'),
                    'type' => Controls_Manager::SLIDER,
                    'dynamic' => ['active' => true],
            ...
            $self->add_control(
                'linear_animation',
                [
                    'label' => esc_html__('Linear Animation', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
                    ...
                    'condition' => [
                        ...
                        + ($extra_fields['linear_animation']['condition'] ?? []),
                    'default' => ($extra_fields['linear_animation']['default'] ?? ''),
                    'selectors' => [
                        '{{WRAPPER}} .swiper-wrapper' => 'transition-timing-function: linear !important;',
                    ],
                ]
            );
            $self->add_control(
                'autoplay',
                [
                    'label' => esc_html__('Autoplay', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'separator' => 'before',
                    'condition' => [
                        'linear_animation!' => 'yes',
            ...
            $self->add_control(
                'autoplay_speed',
                [
                    'label' => esc_html__('Autoplay Speed (ms)', 'courto-core'),
                    'type' => Controls_Manager::NUMBER,
			        'dynamic' => ['active' => true],
                    'condition' => [
                        'autoplay' => 'yes',
            ...
            $self->add_control(
                'autoplay_pause',
                [
                    'label' => esc_html__('Pause On Hover', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'condition' => [
                            'autoplay' => 'yes',
                            'linear_animation!' => 'yes',
            ...
            $self->add_control(
                'autoplay_reverse',
                [
                    'label' => esc_html__( 'Reverse Direction', 'courto-core' ),
                    'type' => Controls_Manager::SWITCHER,
                    'condition' => [
                            'autoplay' => 'yes',
                            'animation_style' => ['default', 'default_vertical'],
            ...
            $self->add_control(
                ...
                [
                    ...
                    'label' => esc_html__('Infinite Loop', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'separator' => 'before',
                    'condition' => [
                            'animation_style' => ['default', 'default_vertical'],
                            'linear_animation!' => 'yes'
                        ] + ($extra_fields['slider_infinite']['condition'] ?? []),
                    'default' => ($extra_fields['slider_infinite']['default'] ?? ''),
                ]
            );
            ...
            $self->add_control(
                'adaptive_height',
                [
                    'label' => esc_html__('Adaptive Height', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
            ...
            $self->add_control(
                'slide_per_single',
                [
                    'label' => esc_html__('Slide per single item', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'condition' => [
                            'animation_style' => ['default'],
                            'linear_animation!' => 'yes',
                        ] + ($extra_fields['slide_per_single']['condition'] ?? []),
                    'default' => ($extra_fields['slide_per_single']['default'] ?? ''),
                ]
            );
            ...
            $self->add_control(
                'fade_animation',
                [
                    'label' => esc_html__('Fade Animation', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'condition' => [
                        'posts_per_row' => '1',
                        'animation_style' => ['default', 'default_vertical'],
            ...
            $self->add_control(
                'center_mode',
                [
                    'label' => esc_html__('Center Mode', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'condition' => [
                        'animation_style' => 'default',
                        'linear_animation!' => 'yes'
                    ] + ($extra_fields['center_mode']['condition'] ?? []),
                    'default' => ($extra_fields['center_mode']['default'] ?? ''),
                ]
            );
        }
        ...
        public static function add_pagination_controls($self, $extra_fields = [])
        {
            ...
            $self->add_control(
                ...
                [
                    ...
                    'default' => ($extra_fields['pagination_type']['default'] ?? 'circle_border'),
                ]
            );
            ...
            $self->add_control(
                'pagination_dynamic',
                [
                    'label' => esc_html__('Dynamic Pagination', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'condition' => [
                        'use_pagination' => 'yes',
            ...
            $self->add_responsive_control(
                'progress_position',
                [
                    'label' => esc_html__('Position of Dynamic Progress', 'courto-core'),
                    'type' => Controls_Manager::CHOOSE,
                    'toggle' => true,
                    'options' => [
                        'top' => [
            ...
            $self->add_responsive_control(
                'pagination_align',
                [
                    'label' => esc_html__('Pagination Alignment', 'courto-core'),
                    'type' => Controls_Manager::CHOOSE,
                    ...
                    'default' => ($extra_fields['pagination_align']['default'] ?? 'center'),
                    'tablet_default' => ($extra_fields['pagination_align']['tablet_default'] ?? null),
                    'mobile_default' => ($extra_fields['pagination_align']['mobile_default'] ?? null),
                    'selectors' => [
                        '{{WRAPPER}} .wgl-carousel_wrapper .wgl-swiper-pagination-wrapper' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
            ...
            $self->add_responsive_control(
                'pagination_margin',
                [
                    'label' => esc_html__('Pagination Margin', 'courto-core'),
                    'type' => Controls_Manager::DIMENSIONS,
                    ...
                    'mobile_default' => ($extra_fields['pagination_margin']['mobile_default'] ?? null),
                    'selectors' => [
                        '{{WRAPPER}} .wgl-carousel_wrapper .wgl-swiper-pagination-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $self->add_control(
                'pagination_custom_colors',
                [
                    'label' => esc_html__('Customize Colors', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
        ...
        public static function add_navigation_controls($self, $extra_fields = [])
        {
            ...
            $self->add_control(
                ...
                [
                    'label' => esc_html__('Add Title for Navigation Controls', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'render_type' => 'template',
                    'condition' => [
                            'use_navigation' => 'yes',
            ...
            $self->add_responsive_control(
                'navigation_diameter',
                [
                    'label' => esc_html__( 'Buttons Diameter', 'courto-core' ),
                    'type' => Controls_Manager::SLIDER,
			        'dynamic' => ['active' => true],
                    'condition' => [
                            'use_navigation' => 'yes',
            ...
            $self->add_responsive_control(
                'navigation_radius',
                [
                    'label' => esc_html__( 'Buttons Border Radius', 'courto-core' ),
                    'type' => Controls_Manager::SLIDER,
			        'dynamic' => ['active' => true],
                    'condition' => [
                            'use_navigation' => 'yes',
                        ] + ( $extra_fields[ 'use_navigation' ][ 'condition' ] ?? [] )
                        + ( $extra_fields[ 'navigation_radius' ][ 'condition' ] ?? [] ),
                    'size_units' => [ 'px', 'rem', 'custom'],
                    'range' => [
                        'px' => [ 'min' => 0, 'max' => 100 ],
                    ],
                    'selectors' => [
                        '{{WRAPPER}} .elementor-swiper-button,
                         {{WRAPPER}} .motion-arrow' => '--wgl-swiper-button-radius: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $self->add_control(
                'navigation_position',
                [
                    'label' => esc_html__('Positioning', 'courto-core'),
                    ...
                    'options' => (
                        $extra_fields['navigation_position']['options'] ?? [
                            '' => esc_html__('Opposite sides', 'courto-core'),
                            'nearby' => esc_html__('Nearby', 'courto-core'),
                            'under_each_other' => esc_html__('Nearby - Under each other', 'courto-core'),
                        ]
                    ),
                    'selectors_dictionary' => [
                    ...
                    'default' => $extra_fields['navigation_position']['default'] ?? '',
                    'selectors' => [
            ...
            $self->add_responsive_control(
                'navigation_distance',
                [
                    'label' => esc_html__('Buttons Distance', 'courto-core'),
                    'type' => Controls_Manager::SLIDER,
			        'dynamic' => ['active' => true],
                    'size_units' => ['px', '%', 'custom'],
                    'condition' => [
                    ...
                    'tablet_default' => $extra_fields['navigation_distance']['tablet_default'] ?? ['unit' => 'px'],
                    'mobile_default' => $extra_fields['navigation_distance']['mobile_default'] ?? ['unit' => 'px'],
                    'selectors' => [
            ...
            $self->add_responsive_control(
                ...
                [
                    ...
                    'default' => $extra_fields['navigation_alignment_h']['default'] ?? 'flex-start',
                    'selectors' => [
            ...
            $self->add_responsive_control(
                ...
                [
                    ...
                    'default' => $extra_fields['navigation_alignment_v']['default'] ?? 'center',
                    'selectors' => [
        ...
        public static function add_responsive_controls($self, $extra_fields = [])
        {
            ...
            $self->add_control(
                'customize_responsive',
                [
                    'label' => esc_html__('Customize Responsive', 'courto-core'),
                    'type' => Controls_Manager::SWITCHER,
            ...
            $self->add_control(
                'heading_widescreen',
                [
                    'label' => esc_html__('Widescreen Desktop Settings', 'courto-core'),
            ...
            $self->add_control(
                ...
                [
                    'label' => esc_html__('Screen Breakpoint', 'courto-core'),
                    'type' => Controls_Manager::NUMBER,
			        'dynamic' => ['active' => true],
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
                        + ($extra_fields['widescreen_breakpoint']['condition'] ?? []),
	                'description' => esc_html__('Equal or greater width screens are targeted.', 'courto-core'),
            ...
            $self->add_control(
                'widescreen_slides',
                [
                    'label' => ($extra_fields['widescreen_slides']['label'] ?? esc_html__('Slides to show', 'courto-core')),
                    'type' => Controls_Manager::NUMBER,
			        'dynamic' => ['active' => true],
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
            ...
            $self->add_control(
                'heading_desktop',
                [
                    'label' => esc_html__('Desktop Settings', 'courto-core'),
                    'type' => Controls_Manager::HEADING,
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
            ...
            $self->add_control(
                'desktop_slides',
                [
                    'label' => ($extra_fields['desktop_slides']['label'] ?? esc_html__('Slides to show', 'courto-core')),
                    'type' => Controls_Manager::NUMBER,
			        'dynamic' => ['active' => true],
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
            ...
            $self->add_control(
                'heading_tablet',
                [
                    'label' => esc_html__('Tablet Settings', 'courto-core'),
                    'type' => Controls_Manager::HEADING,
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
            ...
            $self->add_control(
                'tablet_slides',
                [
                    'label' => ($extra_fields['tablet_slides']['label'] ?? esc_html__('Slides to show', 'courto-core')),
                    'type' => Controls_Manager::NUMBER,
			        'dynamic' => ['active' => true],
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
            ...
            $self->add_control(
                'mobile_slides',
                [
                    'label' => ($extra_fields['mobile_slides']['label'] ?? esc_html__('Slides to show', 'courto-core')),
                    'type' => Controls_Manager::NUMBER,
			        'dynamic' => ['active' => true],
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
        ...
        public static function init($atts, $items = [], $templates = false)
        {
            ...
            if ('default' === $animation_style || 'default_vertical' === $animation_style) {
                if ('default_vertical' === $animation_style || !!$linear_animation){
                ...
                $data_array['linearAnimation'] = (bool) $linear_animation;
                ...
                $output = '<div class="wgl-carousel_wrapper' . esc_attr($wrapper_classes) . '">';
                    ...
                    if ($use_navigation) {
                        $output .= '<div class="wgl-navigation_wrapper">';
                            $output .= '<button class="elementor-swiper-button elementor-swiper-button-prev" data-carousel="' . $carousel_id . '"><span class="title">'.esc_html__('PREV', 'courto-core').'</span><i class="wgl-svg-icon">'.wgl_dynamic_styles()->wgl_theme_svg()['arrow-right'].'</i></button>';
                            $output .= '<button class="elementor-swiper-button elementor-swiper-button-next" data-carousel="' . $carousel_id . '"><span class="title">'.esc_html__('NEXT', 'courto-core').'</span><i class="wgl-svg-icon">'.wgl_dynamic_styles()->wgl_theme_svg()['arrow-right'].'</i></button>';
                        $output .= '</div>';
                    }
                ...
                $output = '<div class="wgl-carousel_wrapper' . esc_attr($wrapper_classes) . '">';
                    $output .= '<div class="wgl-carousel' . esc_attr($carousel_classes) . '">';
                        ...
                        if ($use_navigation) {
                            $output .= '<div class="wgl-navigation_wrapper">';
                                $output .= '<button class="motion-prev motion-arrow" type="button"><i class="wgl-svg-icon">'.wgl_dynamic_styles()->wgl_theme_svg()['arrow-right'].'</i></button>';
                                $output .= '<button class="motion-next motion-arrow" type="button"><i class="wgl-svg-icon">'.wgl_dynamic_styles()->wgl_theme_svg()['arrow-right'].'</i></button>';
                            $output .= '</div>';
                        }
