    ...
    return this.each( function() {
      ...
      $links.each( function( index ) {
        ...
        $(this).on('click', function( e ) {
          ...
          var $section = ( slug !== undefined ) ? $nav.parent().find('[data-section-id="'+slug+'"]') : $sections.eq(index);
          ...
          if ( slug !== undefined && window.location.hash !== '#tab='+slug ) {
      ...
      var hash  = window.location.hash.replace('#tab=', '');
      var $link = ( hash ) ? $links.filter('[data-tab-id="'+hash+'"]') : $links.first();
